...
namespace Jellyfin.Plugin.YoutubeMetadata.Providers
{
    public class YTDLEpisodeProvider: AbstractYoutubeRemoteProvider<YTDLEpisodeProvider, Episode, EpisodeInfo>
    {
        ...
        internal override MetadataResult<Episode> GetMetadataImpl(YTDLData jsonObj, string id) =>
            Utils.YTDLJsonToEpisode(jsonObj, Plugin.Instance?.Configuration, jsonObj.title);
